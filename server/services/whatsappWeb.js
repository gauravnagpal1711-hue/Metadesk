  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
          ...
          for (const m of messages) {
            ...
            const body = extractBody(m.message || {});
                    if (!body) {
                                console.warn('WhatsApp message had no extractable text, saving as [media]. Message keys:', Object.keys(m.message || {}), 'unwrapped keys:', Object.keys(unwrapMessage(m.message || {})));
                    }
